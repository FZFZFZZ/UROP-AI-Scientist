#!/usr/bin/env python3
"""
extract.py — Randomly sample 350 instances (id + abstract) from the ICLR2025 parquet file
...
def main():
    parser = argparse.ArgumentParser(description="Sample 350 instances from ICLR2025 parquet")
    ...
    parser.add_argument("--n", type=int, default=350,
                        help="Number of samples (default=350)")
